        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <span className="email"><i className="icon-mail"></i> dakshsemwal35@gmail.com</span>
              <span className="email"><i className="icon-mail"></i> dsemwal2@gmail.com</span>
              <span className="phone"><i className="icon-phone"></i> +91-8171161278,7906442009</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://twitter.com/Dakshsemwal/" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></li>
